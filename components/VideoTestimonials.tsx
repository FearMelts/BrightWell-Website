                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div>
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
                      {featuredTestimonials[0].title} at {featuredTestimonials[0].company}
                    </p>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">{testimonial.location}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Stethoscope className="w-5 h-5 text-gray-400" />
                  <span className="text-gray-700 dark:text-gray-300">{testimonial.specialty}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Calendar className="w-5 h-5 text-gray-400" />
                  <span className="text-gray-700 dark:text-gray-300">
                    Recorded {new Date(testimonial.dateRecorded).toLocaleDateString()}
                  </span>
                </div>
              </div>
            </div>
